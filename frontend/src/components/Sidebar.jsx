    ...
    <aside className="sidebar px-6">
      <div className="flex flex-col gap-8">
        ...
        <nav className="flex flex-col mt-2 gap-3">
          ...
          <Link to="/tasks" className="sidebar-link px-3 py-2 rounded-md"><ClipboardList size={16} /> <span className="ml-2">Tasks</span> <span className="ml-auto small-badge">{counts.personal || 0}</span></Link>
          ...
          <Link to="/notes" className="sidebar-link px-3 py-2 rounded-md"><FileText size={16} /> <span className="ml-2">Notes</span></Link>
        </nav>
      </div>
    </aside>
  )
